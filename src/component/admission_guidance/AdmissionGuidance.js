        ...
        <div className={styles.containerbox}>
          <div className={styles.birbox}>
            ...
            <p className={styles.bripara}>
              Pre University Secondary/ Sr. Secondary | B.A | BSc | B.Com | BBA
              | BJMC | BBM | M.A | M.Sc | M.Com | MBA | B.Tech | D Pharma | B
              Pharma | Special B.Ed | LLB 5/3 Years | M.Tech | LLM | MCA | BSW |
              GIS | MLTs | DDT | DDA | DEHM | PG DAA | B.P.Ed | DCS | CECG |
              DMLT | DX-Ray | DA | DRIT| Ph.D | etc.{" "}
            </p>
